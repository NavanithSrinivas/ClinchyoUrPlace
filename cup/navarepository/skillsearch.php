 ...
 ?>
			<br>
			  ...
			  <dl class="dropdown"> 
				...
				<dt>
				  <a href="#">
				  <span class="hida">Skill array !</span>    
				  <p class="multiSel"></p>  
				  </a>
				</dt>
			    <dd>
					<div class="mutliSelect">
						<ul>
							<li>
								&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" id="skill" name="check[]" value="1" />c</li>
							<li>
								&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="2" id="skill" name="check[]"/>c++</li>
							<li>
								&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="3"id="skill" name="check[]" />CSS</li>
							<li>
								&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="4" id="skill" name="check[]"/>Java</li>
							<li>
								&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="5" id="skill" name="check[]"/>php</li>
							<li>
								&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="6" id="skill" name="check[]"/>Perl</li>
							<li>
								&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="7" id="skill" name="check[]"/>Javascript</li>
							<li>
								&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="8" id="skill" name="check[]"/>Datastructures</li>
							<li>
								&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="9" id="skill" name="check[]"/>DBMS</li>
							<li>
								&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="10" id="skill" name="check[]"/>Linux</li>
							<li>
								&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="11" id="skill" name="check[]"/>Windows Programming</li>
							<li>
								&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="12" id="skill" name="check[]"/>HTML</li>
							<li>
								&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="13" id="skill" name="check[]"/>Angular JS</li>
							<li>
								&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" value="14" id="skill" name="check[]"/>.Net</li>
...
<input type ="submit" name="submit"  value="SUBMIT"></input>
	...
	<?php if(isset($_POST['submit'])){
		...
		$chosen=$_POST['check'];
		$f=0;
		foreach ($chosen as $res){
			if($f==0){$a=$res ; $f++;}
		$str.=$res.",";
		}

		$result=mysql_query("SELECT * FROM `company_details` WHERE `Skills` like  '$a%' OR `Skills` like '%$str%'  ") ;//or //die("cannot select record<br>"); 
        	?>
