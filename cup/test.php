...
$dbhandle = mysql_connect($hostname, $username, $password)
 ...
 $rows=mysql_fetch_array($rs);
	...
	<p><?php echo $tid ; echo $rows["qst"]; ?></p>
	
	<div class="answ">
	<input type="radio"  id="answ" name="ans" value="<?php echo $rows["opt1"]; ?>" required /><?php echo $rows["opt1"]; ?><br>
	<input type="radio"  id="answ" name="ans" value="<?php echo $rows["opt2"]; ?>" required /><?php echo $rows["opt2"]; ?><br>
	<input type="radio"  id="answ" name="ans" value="<?php echo $rows["opt3"]; ?>" required /><?php echo $rows["opt3"]; ?><br>
   <input type="radio"  id="answ" name="ans" value="<?php echo $rows["opt4"]; ?>" required /><?php echo $rows["opt4"]; ?><br>
...
<center>   <input type="submit" class="next" name="next" value="next >"/></center><?php 
   ...
   ?><input type="submit" name="submit" value="submit" OnClick="dis()"/><?php 
	  ...
	  if(isset($_POST['submit'])){
	   ...
	   ?><script>window.location="http://localhost/cup/marks.php" </script><?php }  ?>
